...
import model.coap.CoapCode;
import model.coap.CoapMessage;
import model.coap.CoapType;
...
import util.CoapUtil;
import util.MessageSenderUtil;
...
public class CoapClientApplication extends JFrame {
    ...
    public static void main(String[] args) throws Exception {
        CoapClientApplication program = new CoapClientApplication();
        program.setVisible(true);
    }

    public CoapClientApplication() throws Exception {
        super("Coap Client");

        ...
        switch(message.getCode()) {
            case GET: {
                if(CoapUtil.isUrl(message, "pi", "time")) {
                    ...
                    try {
                        float temperature = Float.parseFloat(HttpUtil.plainTextHttpGetRequest("http://" +ServerConfig.PI_URI + "/temperature"));
                    ...
                    try {
                        float humidity = Float.parseFloat(HttpUtil.plainTextHttpGetRequest("http://" +ServerConfig.PI_URI + "/humidity"));
